...
def has_real_no_response(conn, market_action_spec_id: str, action_request_id: str) -> bool:
    ...
    proof is REAL_PROVIDER — the only currently-representable REAL outcome (an authenticated
    provider observation origin is a deferred, schema-gated enhancement)."""
